...
@endif
        ...
        <h2>ADMIN</h2>  
  <p>Click here to go to admin panel</p> 
  <a href="{{route('admin.login')}}" class="btn btn-success">Admin</a>
  </div>
  </div>
...
@endif
  ...
  <h2>CITIZENS</h2>
  <p>Click here to go to website</p>
  <br>
  <a href="{{route('user')}}" class="btn_sign_up">Citizen</a>
  <!-- <button class="btn_sign_up">citizen</button> -->
</div>
  </div>
       </div>
